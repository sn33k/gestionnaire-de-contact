...
REF_CT<br />
De la forme AAAAMM<br />
AAAA n° du contact cré avec function/table conmpteur ???<br />
...
// INSERT INTO CONTACTS(REF_CT, CT_QUAL , CT_NOM, CT_PRE, CT_ADR,CT_VILLE) VALUES (.$REF_CT., .$CT_QUAL., .$CT_NOM., .$CT_PRE., .$CT_ADR., .$CT_VILLE.)
?>
...
<div style="display:inline; width:200px; height:48px; padding:0; margin:auto;">
